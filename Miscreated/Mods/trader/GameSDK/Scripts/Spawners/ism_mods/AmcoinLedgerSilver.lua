...
local newItem = {
  class = "AmcoinLedgerSilver", -- the item class name needs to be the same as the one in the xml file
  percent = 10, -- the percentage will need to be substracted from an existing field in the category
  percent2 = 5,
}
...
local categoryItemToAdjust2 = FindInTable(categoryToAdjust.classes, "class", "RandomMushroom")
...
categoryItemToAdjust.percent = 75
