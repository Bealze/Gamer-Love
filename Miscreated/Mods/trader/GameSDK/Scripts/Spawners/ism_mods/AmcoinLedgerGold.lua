...
local newItem = {
  class = "AmcoinLedgerGold", -- the item class name needs to be the same as the one in the xml file
...
local categoryToAdjust2 = FindInTable(ItemSpawnerManager.itemCategories, "category", "RandomHumanSpiderLoot")
...
local categoryItemToAdjust2 = FindInTable(categoryToAdjust.classes, "class", "RandomConsumable")
...
categoryItemToAdjust.percent = 93
