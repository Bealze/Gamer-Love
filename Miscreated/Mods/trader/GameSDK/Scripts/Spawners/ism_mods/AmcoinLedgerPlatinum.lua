...
local newItem = {
  class = "AmcoinLedgerPlatinum", -- the item class name needs to be the same as the one in the xml file
  percent = 2, -- the percentage will need to be substracted from an existing field in the category
}
