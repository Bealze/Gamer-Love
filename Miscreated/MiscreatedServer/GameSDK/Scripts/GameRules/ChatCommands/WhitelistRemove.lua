-- !whitelistRem
-- Remove SteamID64 from Whitelist
  ChatCommands["!whitelistrem"] = function(playerId, command)
    Log(">> !whitelistrem - %s", command)
    ...
    if allowCommand then
      System.ExecuteCommand("mis_whitelist_remove" .. command)
